<x-layout>
    ...
    <div class="container mx-auto">
        <form action="{{ route('register.store') }}" method="POST" class="w-full border mt-2 border-gray-200 rounded flex flex-col gap-4 p-4">
            @csrf
            <x-forms.field required name="name" class="flex flex-col gap-2">
            ...
            <x-forms.field required name="password_confirmation" class="flex flex-col gap-2">
                <x-forms.label>Password</x-forms.label>
